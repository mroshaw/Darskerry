...
namespace DaftAppleGames.Darskerry.Core.DagCharacterController.Input
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Roll"",
                    ""type"": ""Button"",
                    ""id"": ""7ad2037f-da7f-4f5c-bbe8-b8cdef50de83"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""ToggleCrouch"",
                    ""type"": ""Button"",
                    ""id"": ""216ba422-e77c-468d-8526-fc308ae835af"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""46df0cec-3de2-4b35-80b8-e02a2e33c243"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0c616190-5e35-4630-8ee4-a2cc5ffd6b2d"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard and Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""5ff3a60a-7c74-440f-bc42-7ce5b3c0af23"",
                    ""path"": ""<Keyboard>/c"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""704dcc88-ead7-444b-9ffb-af458eba6967"",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_DebugMap_ToggleGPUI = m_DebugMap.FindAction("ToggleGPUI", throwIfNotFound: true);
            // FlyCamMap
            m_FlyCamMap = asset.FindActionMap("FlyCamMap", throwIfNotFound: true);
            m_FlyCamMap_FlyForward = m_FlyCamMap.FindAction("FlyForward", throwIfNotFound: true);
            m_FlyCamMap_FlyBackward = m_FlyCamMap.FindAction("FlyBackward", throwIfNotFound: true);
            m_FlyCamMap_FlyLeft = m_FlyCamMap.FindAction("FlyLeft", throwIfNotFound: true);
            m_FlyCamMap_FlyRight = m_FlyCamMap.FindAction("FlyRight", throwIfNotFound: true);
            m_FlyCamMap_FlyUp = m_FlyCamMap.FindAction("FlyUp", throwIfNotFound: true);
            m_FlyCamMap_FlyDown = m_FlyCamMap.FindAction("FlyDown", throwIfNotFound: true);
            m_FlyCamMap_FlyToggleFocus = m_FlyCamMap.FindAction("FlyToggleFocus", throwIfNotFound: true);
            m_FlyCamMap_FlySpeedUp = m_FlyCamMap.FindAction("FlySpeedUp", throwIfNotFound: true);
            m_FlyCamMap_FlyLook = m_FlyCamMap.FindAction("FlyLook", throwIfNotFound: true);
        }
        ...
        ~@PlayerControls()
        {
            ...
            Debug.Assert(!m_ThirdPersonMap.enabled, "This will cause a leak and performance issues, PlayerControls.ThirdPersonMap.Disable() has not been called.");
            Debug.Assert(!m_PlayerActionsMap.enabled, "This will cause a leak and performance issues, PlayerControls.PlayerActionsMap.Disable() has not been called.");
            Debug.Assert(!m_SystemActionsMap.enabled, "This will cause a leak and performance issues, PlayerControls.SystemActionsMap.Disable() has not been called.");
            Debug.Assert(!m_DebugMap.enabled, "This will cause a leak and performance issues, PlayerControls.DebugMap.Disable() has not been called.");
            Debug.Assert(!m_FlyCamMap.enabled, "This will cause a leak and performance issues, PlayerControls.FlyCamMap.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_DebugMap_ToggleGPUI;
        public struct DebugMapActions
        {
            private @PlayerControls m_Wrapper;
            public DebugMapActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
            public InputAction @ToggleGPUI => m_Wrapper.m_DebugMap_ToggleGPUI;
        ...
        private readonly InputAction m_FlyCamMap_FlyForward;
        private readonly InputAction m_FlyCamMap_FlyBackward;
        private readonly InputAction m_FlyCamMap_FlyLeft;
        private readonly InputAction m_FlyCamMap_FlyRight;
        private readonly InputAction m_FlyCamMap_FlyUp;
        private readonly InputAction m_FlyCamMap_FlyDown;
        private readonly InputAction m_FlyCamMap_FlyToggleFocus;
        private readonly InputAction m_FlyCamMap_FlySpeedUp;
        private readonly InputAction m_FlyCamMap_FlyLook;
        public struct FlyCamMapActions
        {
            private @PlayerControls m_Wrapper;
            public FlyCamMapActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
            public InputAction @FlyForward => m_Wrapper.m_FlyCamMap_FlyForward;
            public InputAction @FlyBackward => m_Wrapper.m_FlyCamMap_FlyBackward;
            public InputAction @FlyLeft => m_Wrapper.m_FlyCamMap_FlyLeft;
            public InputAction @FlyRight => m_Wrapper.m_FlyCamMap_FlyRight;
            public InputAction @FlyUp => m_Wrapper.m_FlyCamMap_FlyUp;
            public InputAction @FlyDown => m_Wrapper.m_FlyCamMap_FlyDown;
            public InputAction @FlyToggleFocus => m_Wrapper.m_FlyCamMap_FlyToggleFocus;
            public InputAction @FlySpeedUp => m_Wrapper.m_FlyCamMap_FlySpeedUp;
            public InputAction @FlyLook => m_Wrapper.m_FlyCamMap_FlyLook;
