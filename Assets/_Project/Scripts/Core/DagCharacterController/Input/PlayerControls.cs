...
namespace DaftAppleGames.Darskerry.Core.DagCharacterController.Input
{
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_FlyCamMap_FlyLookEnabled = m_FlyCamMap.FindAction("FlyLookEnabled", throwIfNotFound: true);
        }
        ...
        ~@PlayerControls()
        {
            ...
            UnityEngine.Debug.Assert(!m_SystemActionsMap.enabled, "This will cause a leak and performance issues, PlayerControls.SystemActionsMap.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_DebugMap.enabled, "This will cause a leak and performance issues, PlayerControls.DebugMap.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_FlyCamMap.enabled, "This will cause a leak and performance issues, PlayerControls.FlyCamMap.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_FlyCamMap_FlyLookEnabled;
        public struct FlyCamMapActions
        {
            ...
            public InputAction @FlyLookEnabled => m_Wrapper.m_FlyCamMap_FlyLookEnabled;
