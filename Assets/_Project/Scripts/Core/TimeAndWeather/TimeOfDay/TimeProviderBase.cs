...
namespace DaftAppleGames.Darskerry.TimeAndWeather.TimeOfDay
{
    /// <summary>
    ...
    {
        [BoxGroup("Event Settings")] public int dayStartTime = 6;
