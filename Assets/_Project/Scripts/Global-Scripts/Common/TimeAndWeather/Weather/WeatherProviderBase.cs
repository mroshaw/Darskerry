...
namespace DaftAppleGames.Common.TimeAndWeather.Weather
{
    /// <summary>
    ...
    {
        [BoxGroup("Events")] public UnityEvent<WeatherPresetSettingsBase> onWeatherPresetAppliedEvent;
        ...
        private WeatherPresetSettingsBase _currentWeather;
        ...
        /// <summary>
        /// Prepare for the first transition
        /// </summary>
        private void Awake()
        {
        ...
        /// accessing them by preset name from the two Dictionaries.
        /// </summary>
        ...
        {
            if (_currentWeather != null && _currentWeather.presetName == weatherPreset.presetName)
            {
                return;
            }
        ...
        /// <summary>
        /// Picks a random preset from the possible transition presets and set that as the active weather
        /// </summary>
        public void StartRandomWeather()
        {
            int numTransitionPreset = _currentWeather.canTransitionToWeatherPresets.Count;

            Random newRandom = new Random();
            int transitionIndex = newRandom.Next(0, numTransitionPreset);
            ApplyWeatherPreset(_currentWeather.canTransitionToWeatherPresets[transitionIndex].CanTransitionToWeatherPreset);
        }
    }
}