...
namespace DaftAppleGames.Common.Weather
{
    public abstract class WeatherProviderBase : TimeAndWeatherProviderBase
    {
        ...
        public void ApplyWeatherPreset(WeatherPresetSettingsBase weatherPreset, float transitionDuration)
        {
            ...
            ApplyWeatherPresetProvider(weatherPreset, transitionDuration);
        ...
        /// <param name="weatherPreset"></param>
        /// <param name="transitionDuration"></param>
        public abstract void ApplyWeatherPresetProvider(WeatherPresetSettingsBase weatherPreset, float transitionDuration);
