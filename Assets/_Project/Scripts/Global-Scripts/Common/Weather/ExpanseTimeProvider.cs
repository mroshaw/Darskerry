...
namespace DaftAppleGames.Common.Weather
{
    public class ExpanseTimeProvider : TimeProviderBase
    {
        ...
        public override void ApplyTimePresetProvider(TimeOfDayPresetSettingsBase timePreset, float transitionDuration)
        {
            ...
            {
                TimeAndWeatherManager.ApplyWeatherPreset(expanseTimePreset.expanseWeatherSettings, expanseTimePreset.expanseWeatherTransitionDuration);
            }
        }
    }
}