...
namespace DaftAppleGames.Common.Audio
{
    ...
    public class CustomAudioManager : MonoBehaviour
    {
        ...
        /// </summary>
        [NonSerialized]
        public List<CustomAudioZone> m_activeAudioZones = new List<CustomAudioZone>();

        /// <summary>
        /// Audiozones slated for deactivation
        /// </summary>
        [NonSerialized]
        public List<CustomAudioZone> m_becomingInActiveAudioZones = new List<CustomAudioZone>();

        /// <summary>
        /// Currently inactive audiozones
        /// </summary>
        [NonSerialized]
        public List<CustomAudioZone> m_inactiveAudioZones = new List<CustomAudioZone>();
        ...
        /// </summary>
        private static CustomAudioManager m_instance = null;
        ...
        private void Update()
        {
            ...
            {
                CustomAudioZone az = m_activeAudioZones[currentZone];
                if (az != null)
                {
        ...
        {
            CustomAudioZone[] audioZones = GameObject.FindObjectsOfType<CustomAudioZone>();
            foreach (CustomAudioZone audioZone in audioZones)
            {
                if (audioZone != null)
                {
        ...
        public void RegisterAudioZone(CustomAudioZone az)
        {
        ...
        public void DeRegisterAudioZone(CustomAudioZone az)
        {
        ...
        protected void ActivateAudioZone(CustomAudioZone az)
        {
        ...
        protected void FlagAudioZoneForDeactivation(CustomAudioZone az)
        {
        ...
        /// </summary>
        /// <param name="az">Audiozone to activate</param>
        protected void DeActivateAudioZone(CustomAudioZone az)
        {
            if (!m_inactiveAudioZones.Contains(az))
            {
                az.Deactivate();
        ...
        private IEnumerator UpdateAudioZoneStates()
        {
            ...
            while (true)
            {
                ...
                if (m_player != null)
                {
                    ...
                    {
                        CustomAudioZone zone = m_activeAudioZones[currentZone];
                    ...
                    {
                        CustomAudioZone zone = m_becomingInActiveAudioZones[currentZone];
                    ...
                    {
                        CustomAudioZone zone = m_inactiveAudioZones[currentZone];
