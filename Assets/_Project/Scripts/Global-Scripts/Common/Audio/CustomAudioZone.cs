...
{
    [System.Serializable]
    public class CustomAudioZoneItem
    {
    ...
    [ExecuteInEditMode]
    [Serializable]
    public class CustomAudioZone : MonoBehaviour
    {
        /// <summary>
        /// Audiozone states
        /// </summary>
        ...
        /// </summary>
        public List<CustomAudioZoneItem> m_audioList = new List<CustomAudioZoneItem>();

        /// <summary>
        /// Currently playing audio item
        /// </summary>
        [NonSerialized]
        public CustomAudioZoneItem m_currentAudioItem = null;
        ...
        private void Start()
        {
            ...
            {
                CustomAudioManager.Instance.RegisterAudioZone(this);
            }
        }
        ...
        private void OnDestroy()
        {
            if (CustomAudioManager.Instance != null)
            {
                CustomAudioManager.Instance.DeRegisterAudioZone(this);
            }
        }
        ...
        {
            Debug.Log($"Custom Audio in Zone: {this.name}");
