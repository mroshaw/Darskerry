...
namespace DaftAppleGames.Common.Debugger
{
    public class DebugTimeAndWeatherUi : DebugBaseUi
    {
        ...
        [BoxGroup("UI Settings")] public TMP_InputField timeTransitionDurationText;
        [BoxGroup("UI Settings")] public TMP_InputField weatherTransitionDurationText;
        ...
        public void SetTimeProxy()
        {
            ...
            float timeTransitionDuration = float.Parse(timeTransitionDurationText.text);
            _debugTimeAndWeather.SetTimeOfDay(currentTargetName, timeTransitionDuration);
        }
        ...
        public void SetWeatherProxy()
        {
            ...
            float weatherTransitionDuration = float.Parse(weatherTransitionDurationText.text);
            _debugTimeAndWeather.SetWeather(currentTargetName, weatherTransitionDuration);
        }
    }
}