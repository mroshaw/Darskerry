...
namespace DaftAppleGames.Editor.CharacterTools
{
    ...
    /// </summary>
    public class NpcCharacterEditorWindow : BaseCharacterEditorWindow
    {
        ...
        [MenuItem("Daft Apple Games/Characters/Invector NPC editor")]
        public static void ShowWindow()
        {
            GetWindow(typeof(NpcCharacterEditorWindow));
        }
