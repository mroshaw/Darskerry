...
namespace DaftAppleGames.Editor.CharacterTools
{
    ...
    /// </summary>
    public class BaseCharacterEditorWindow : OdinEditorWindow
    {
        [BoxGroup("Character Settings")] public BaseCharacterSettings characterSettings;
        [BoxGroup("Character Settings")]public GameObject playerGameObject;
