...
namespace DaftAppleGames.Editor.CharacterTools
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "EmeraldAIAutoEditorSettings", menuName = "Daft Apple Games/AI/Emerald AI editor settings", order = 1)]
    public class EmeraldAIEditorSettings : ScriptableObject
    {
