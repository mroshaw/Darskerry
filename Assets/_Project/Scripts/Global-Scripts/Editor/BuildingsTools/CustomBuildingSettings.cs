using DaftAppleGames.Editor.EditorTools.DrawerAttributes;
...
namespace DaftAppleGames.Editor.BuildingTools
{
    ...
    public class CustomBuildingSettings : ScriptableObject
    {
        ...
        [BoxGroup("Behaviour Settings")] [Tooltip("These are optional tags that can be added to the checks when a GameObject collider triggers volume functionality. For example, if your Player has a main collider with the 'Player' tag.")] [Tag] public string[] TriggerTags;
        [BoxGroup("Behaviour Settings")] [Tooltip("This is the layer in which all trigger Colliders will be added.")] [Layer] public string triggerLayerName;
        
        [BoxGroup("Exterior Layer Settings")] [Tooltip("This is the layer that will be applied to exterior Mesh Renderer Game Objects.")] [Layer] public string exteriorLayerName;
        [BoxGroup("Exterior Layer Settings")] [Tooltip("This is the layer that will be applied to exterior prop Mesh Renderer Game Objects.")] [Layer] public string exteriorPropsLayerName;
        [BoxGroup("Interior Layer Settings")] [Tooltip("This is the layer that will be applied to interior Mesh Renderer Game Objects.")] [Layer] public string interiorLayerName;
        [BoxGroup("Interior Layer Settings")] [Tooltip("This is the layer that will be applied to interior prop Mesh Renderer Game Objects.")] [Layer] public string interiorPropsLayerName;
