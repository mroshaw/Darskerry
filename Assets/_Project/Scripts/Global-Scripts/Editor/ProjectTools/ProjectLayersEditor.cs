...
{
    public class ProjectLayersEditor : ProjectBaseEditor, IProjectEditor
    {
        [BoxGroup("Project Layers Settings")] public List<string> layers = new List<string>();
        [BoxGroup("Project Layers Settings")] public bool replaceExisting = true;
        private SerializedObject _tagManager;
        private SerializedProperty _layersProp;
        private int _totalLayers;

        [MenuItem("Daft Apple Games/Tools/Project/Project layers setup")]
        public static void ShowWindow()
        {
            GetWindow(typeof(ProjectLayersEditor));
        }
