...
{
    public class ProjectFoldersEditor : ProjectBaseEditor, IProjectEditor
    {
        [BoxGroup("Project Folder Settings")]
        public List<ProjectFolder> folders = new List<ProjectFolder>();

        [MenuItem("Daft Apple Games/Tools/Project/Project folders setup")]
        public static void ShowWindow()
        {
            GetWindow(typeof(ProjectFoldersEditor));
        }
