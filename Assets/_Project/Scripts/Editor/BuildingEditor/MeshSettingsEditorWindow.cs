...
namespace DaftAppleGames.Editor.ObjectTools
{
    ...
    public class MeshSettingsEditorWindow : OdinEditorWindow
    {
        ...
        [PropertyOrder(1)] [BoxGroup("Settings")] [InlineEditor] [SerializeField]
        private MeshSettings meshSettings;

        [PropertyOrder(1)] [BoxGroup("Selected Objects")] [SerializeField]
        ...
        [PropertyOrder(3)] [BoxGroup("Individual Settings")] [SerializeField]
        ...
        [PropertyOrder(4)] [BoxGroup("Individual Settings")] [SerializeField]
        ...
        [PropertyOrder(5)] [BoxGroup("Individual Settings")] [SerializeField]
        ...
        [PropertyOrder(6)] [BoxGroup("Individual Settings")] [SerializeField]
        ...
        [PropertyOrder(8)] [Button("Fix LOD Groups")] public void FixLodGroups()
        {
