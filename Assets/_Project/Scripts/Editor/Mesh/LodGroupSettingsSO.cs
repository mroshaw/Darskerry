...
namespace DaftAppleGames.Editor.ObjectTools
{
    ...
    {
        [BoxGroup("LOD Group Settings")] public float[] twoLodWeights = new float[] { 0.1f, 0.8f };
        [BoxGroup("LOD Group Settings")] public float[] threeLodWeights = new float[] { 0.1f, 0.4f, 0.4f };
        [BoxGroup("LOD Group Settings")] public float[] fourLodWeights = new float[] { 0.1f, 0.3f, 0.3f, 0.3f };
        [BoxGroup("LOD Group Settings")] public float[] fiveLodWeights = new float[] { 0.1f, 0.2f, 0.2f, 0.2f, 0.2f };
        [BoxGroup("LOD Group Settings")] public LODFadeMode fadeMode = LODFadeMode.CrossFade;
        [BoxGroup("LOD Group Settings")] public float cullRatio = 0.1f;
    }
}